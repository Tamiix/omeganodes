...
const CryptoPaymentModal = ({ isOpen, onClose, amount, commitment, rps = 100, tps = 50, serverType = "shared", rentAccessEnabled = false, isTestMode = false }: CryptoPaymentModalProps) => {
            ...
            <div className="space-y-5 py-4">
              ...
              {!profile?.discord_id && (
                <div className="p-4 rounded-lg bg-[#5865F2]/10 border border-[#5865F2]/30">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">Connect Discord Required</p>
                      <p className="text-xs text-muted-foreground">Link your Discord to receive access to your panel</p>
                    </div>
                  </div>
                  <Button
              ...
              <div className="flex gap-3 pt-2">
                ...
                <Button 
                  variant="omega" 
                  className="flex-1"
                  disabled={!selectedCrypto || !profile?.discord_id}
                  onClick={handlePaymentSent}
                >
                  {!profile?.discord_id ? "Connect Discord First" : "I've Sent Payment"}
                </Button>
              </div>
            </div>
          </>
